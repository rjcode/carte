...
<ol>
	<li>Refactor and document existing code before moving forward</li>
	...
	<li>Add support for one-to-many, many-to-one associations, when you delete an item with one-to-many associations then you will also delete the associated items</li>
